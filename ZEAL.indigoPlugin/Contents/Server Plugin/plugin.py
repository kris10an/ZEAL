...
class Plugin(indigo.PluginBase):
	...
	def __init__(self, pluginId, pluginDisplayName, pluginVersion, pluginPrefs):
		...
		# Set log levels
		self.logger.debug(u'Setting log level to %s' % (pluginPrefs.get(u'logLevel', u'INFO'))
		self.indigo_log_handler.setLevel(INFO)
		self.logger.debug(u'Setting file log level to DEBUG')
